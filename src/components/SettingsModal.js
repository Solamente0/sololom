...
export default class SettingsModal {
  ...
  cacheElements() {
    ...
    this.elements.temperatureValue =
      this.modal.querySelector("#temperatureValue");
  }
    ...
    if (this.elements.temperatureSlider && this.elements.temperatureValue) {
      this.elements.temperatureSlider.addEventListener("input", () => {
        this.elements.temperatureValue.textContent =
          this.elements.temperatureSlider.value;
      });
    }
  ...
  populateForm() {
    ...
    if (this.elements.chatTitleInput) {
      this.elements.chatTitleInput.value =
        this.settings.title || "New Conversation";
    }
    ...
    if (this.elements.systemPromptInput) {
      this.elements.systemPromptInput.value =
        this.settings.systemPrompt || "You are a helpful assistant.";
    }
  }
  ...
  handleSave() {
    ...
    if (this.elements.chatTitleInput) {
      newSettings.title =
        this.elements.chatTitleInput.value.trim() || "New Conversation";
    }

    // Get temperature
    if (this.elements.temperatureSlider) {
      newSettings.temperature = parseFloat(
        this.elements.temperatureSlider.value
      );
    }
