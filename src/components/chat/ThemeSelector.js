...
export default class ThemeSelector {
  ...
  renderButtons() {
    ...
    lightButton.className = `theme-button ${this.theme === 'light' ? 'active' : ''}`;
    ...
    darkButton.className = `theme-button ${this.theme === 'dark' ? 'active' : ''}`;
    ...
    switch (this.options.type) {
      ...
      case 'buttons':
        ...
        buttons.forEach(button => {
          if ((button.textContent.includes('Light') && this.theme === 'light') ||
