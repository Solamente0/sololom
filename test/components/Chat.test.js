...
describe("Chat Component", () => {
  ...
  describe("Initialization", () => {
    ...
    it("should load existing conversation if conversationId is provided", async () => {
      ...
      StorageService.getConversationById.mockResolvedValueOnce(
      ...
      expect(StorageService.getConversationById).toHaveBeenCalledWith(
        "test-conversation"
      );
  ...
  describe("Sending Messages", () => {
    ...
    it("should handle API errors gracefully", async () => {
      ...
      expect(chat.conversation).toEqual([{ role: "user", content: "Hello" }]);
    });
