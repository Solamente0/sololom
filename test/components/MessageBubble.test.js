...
describe('MessageBubble Component', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render an assistant message with markdown and copy button', () => {
      ...
      helpers.renderMarkdown.mockReturnValueOnce('<p>Hello <strong>world</strong> with <code>code</code></p>');
      ...
      expect(helpers.renderMarkdown).toHaveBeenCalledWith('Hello **world** with `code`');
  ...
  describe('Content updates', () => {
    ...
    it('should re-render markdown when updating assistant message content', () => {
      ...
      expect(helpers.renderMarkdown).toHaveBeenCalledWith('Updated **content**');
    });
  });
  ...
  describe('Highlighting', () => {
    it('should highlight matching text in a message', () => {
      ...
      expect(messageBubble.options.content).toBe('This is a test message about highlighting');
    });
    ...
    it('should support case-sensitive highlighting', () => {
      ...
      expect(element.innerHTML).not.toContain('<span class="highlight">TEST</span>');
      expect(element.innerHTML).toContain('<span class="highlight">test</span>');
    });
