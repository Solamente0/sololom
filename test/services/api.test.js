...
describe("API Service", () => {
  ...
  describe("getLLMResponse", () => {
    it("should call the appropriate API based on the model", async () => {
      ...
      const mockAnthropicResponse = {
        ...
        json: jest
          .fn()
          .mockResolvedValue({ content: [{ text: "Anthropic response" }] }),
      };
      ...
      const anthropicResponse = await ApiService.getLLMResponse(
        anthropicParams
      );
      ...
      expect(mistralResponse).toEqual({
        choices: [{ message: { content: "Mistral response" } }],
      });
    });
  ...
  describe("extractContentFromResponse", () => {
    ...
    it("should extract content from Anthropic response", () => {
      ...
      const content = ApiService.extractContentFromResponse(
        response,
        "anthropic"
      );
